        ...
        mAuth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        Intent intent = new Intent(LoginActivity.this, HomePageActivity.class);  // Navigating to ActivityHomeScreen
                        startActivity(intent);
                        ...
                        if (task.getException() != null) {
                            ...
                            if (errorMessage != null) {
                                if (errorMessage.contains("There is no user record")) {
                                    ...
                                    Toast.makeText(LoginActivity.this, "Email doesn't exist, try signing up.", Toast.LENGTH_SHORT).show();
